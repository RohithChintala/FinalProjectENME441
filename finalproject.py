...
mmins = data.getvalue('mmins') 
nmins = data.getvalue('nmins') 
rmins = data.getvalue('rmins') 
...
web = {"sounds":sounds, "mhours":mhours, "nhours":nhours, "rhours":rhours, "mmins":mmins, "nmins":nmins, "rmins":rmins, "mtime":mtime, "ntime":ntime, "rtime":rtime}
...
print('</select><br /><br />How Early to Wake Up Before Event:<select id="mhours">')
...
print('</select><select id="mmin">')
print('<option value="a">0</option>')
print('<option value="b">15</option>')
print('<option value="c">30</option>')
print('<option value="d">45</option>')
print('</select><select id="mtime">')
print('<option value="am">AM</option>')
print('<option value="pm">PM</option>')
print('</select><br /><br />When to set the bedtime alarm:<select id="nhours">')
print('<option value="1">1</option>')
print('<option value="2">2</option>')
print('<option value="3">3</option>')
print('<option value="4">4</option>')
...
print('<option value="11">11</option>')
print('<option value="12">12</option>')
print('</select><select id="nmin">')
print('<option value="a">0</option>')
print('<option value="b">15</option>')
print('<option value="c">30</option>')
print('<option value="d">45</option>')
print('</select><select id="ntime">')
print('<option value="am">AM</option>')
print('<option value="pm">PM</option>')
print('</select><br /><br />When to Refresh:<select id="rhours">')
print('<option value="1">1</option>')
print('<option value="2">2</option>')
print('<option value="3">3</option>')
print('<option value="4">4</option>')
...
print('<option value="11">11</option>')
print('<option value="12">12</option>')
print('</select><select id="rmin">')
print('<option value="a">0</option>')
print('<option value="b">15</option>')
print('<option value="c">30</option>')
print('<option value="d">45</option>')
print('</select><select id="rtime">')
print('<option value="am">AM</option>')
print('<option value="pm">PM</option>')
