...
web = {"sounds":sounds, "mhours":mhours, "nhours":nhours, "rhours":rhours, "mmin":mmin, "nmin":nmin, "rmin":rmin, "mtime":mtime, "ntime":ntime, "rtime":rtime, "test":test}
...
print('<div style="width: 1200px; background: #b0e0e6; border: 1px; text-align: center;"><br />')
...
print('</select>')
print('<input type="radio" name="test" value="test" > Test Sound')
