...
print('<label for="sounds">Choose Sound: </label><select name="sounds" name="sounds">')
...
print('<option value="1">0</option>')
print('<option value="2">15</option>')
print('<option value="3">30</option>')
...
print('<option value="2">15</option>')
print('<option value="3">30</option>')
print('<option value="4">45</option>')
