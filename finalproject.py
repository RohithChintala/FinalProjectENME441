...
print('<div style="width: 600px; background: #b0e0e6; border: 1px; text-align: left;"><br />')
...
print('</form>')
print('Current Wake UP Alarm is: %s:%s ' % (mhours,mmin) 'Before Event')
print('Current Sleep Alarm is: %s:%s ' % (nhours,nmin) 'Before Event')
